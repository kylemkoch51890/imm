...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="screen" href="css/capabilities.css">
      ...
      <section class="capabilities">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <div class="col-sm-12">
                <h3>CNC Mill &amp; CNC Lathe Machining</h3>
                <p>Mastercam certified in both Mill and Lathe design capabilities</p>
              </div>
              <div class="col-sm-12">
                <h3>Patterns</h3>
                <p>Wood &sol; Metal &sol; Plastic &sol; Styrofoam &sol; Lost Wax &sol; Lost Foam</p>
              </div>
              <div class="col-sm-12">
                <h3>Forging Dies</h3>
                <p>New &sol; Die Repair</p>
              </div>
              <div class="col-sm-12">
                <h3>Cast to Size Tooling</h3>
              </div>
              <div class="col-sm-12">
                <h3>Prototype Work</h3>
              </div>
            </div>
            <div class="col-md-6">
              <div class="col-sm-12">
                <h3>CAD Design Molds</h3>
                <p>Vacuum &sol; Thermoform &sol; Plastic Injected &sol; Investment Casting &sol; Lost Foam &amp; Lost Wax &sol; Blow &sol; Prototype &sol; Silicone</p>
              </div>
              <div class="col-sm-12">
                <h3>Fixtures</h3>
                <p>Inspection Fixtures &sol; Check Fixtures &sol; Assembly Fixtures</p>
              </div>
              <div class="col-sm-12">
                <h3>Machine Design &amp; Build</h3>
                <p>PLC &amp; Servo Control</p>
              </div>
              <div class="col-sm-12">
        ...
        <div class="container">
          <aside>
            <div class="content service">
              <h3>Service</h3>
              <p>Unmatched customer service through a friendly staff and the use of technology.</p>
            </div>
          </aside>
          ...
          <aside>
            <div class="content quality">
              <h3>Quality</h3>
              <p>Unequaled quality by leveraging over 136 years of combined experience.</p>
            </div>
          </aside>
          ...
          <aside>
            <div class="content innovation">
              <h3>Innovation</h3>
              <p>Out of the box ways to solve problems and get solutions.</p>
            </div>
          </aside>
          ...
          <aside>
            <div class="content speed">
              <h3>Speed</h3>
              <p>Products and delivery when you need them.</p>
            </div>
          </aside>
        </div>
      </section>
