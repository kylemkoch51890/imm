    ...
    <main role="main" id="main">
      ...
      <header style="background-image("")">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2>Design &sol; Reverse Engineering</h2>
            </div>
          </div>
        </div>
      </header>
      ...
      <div class="slideshow-container">
        ...
        <div class="mySlides">
          <img src="../images/design_reverse_engineering/11_19_IMM_81.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/design_reverse_engineering/11_19_IMM_83.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/design_reverse_engineering/11_19_IMM_84.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/design_reverse_engineering/11_19_IMM_93.png" style="width:100%">
        </div>
      ...
      <section class="our-machines">
        <div class="container">
          <ul class="breadcrumb">
            ...
            <li>Design &sol; Reverse Engineering</li>
          </ul>
        </div>
      </section>
      <!-- End Our Machines -->
