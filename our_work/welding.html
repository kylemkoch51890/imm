  ...
  <div id="subpage">
    ...
    <main role="main" id="main">
      ...
      <div class="slideshow-container">
        ...
        <div class="mySlides">
          <img src="../images/welding/11_19_IMM_34.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/welding/11_19_IMM_37.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/welding/11_19_IMM_38.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/welding/11_19_IMM_62.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/welding/11_19_IMM_59.png" style="width:100%">
        </div>

        <div class="mySlides">
          <img src="../images/welding/11_19_IMM_16.png" style="width:100%">
        </div>
