    ...
    <main role="main" id="main">
      ...
      <header style="background-image("")">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2>Contact Us</h2>
              <p>Questions? Comments? Let us know how we can better serve you.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section class="contact">
        <div class="container">
          <div class="row">
            <div class="col-md-8">
              <iframe title="Embedded Wufoo Form" height="577" allowTransparency="true" frameborder="0" scrolling="no" style="width:100%;border:none" src="https://webcontac.wufoo.com/embed/x13v7zyi0pkzenx/">
                <a href="https://webcontac.wufoo.com/forms/x13v7zyi0pkzenx/">
            ...
            <div class="col-md-4">
              <div class="address">
                <div class="resp-map">
                  <iframe class="resp-iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2985.4017313756904!2d-83.47964158345677!3d41.56054928685183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x883b8f6c294cf26d%3A0x1230d44587c23e0c!2s4370%20Moline%20Martin%20Rd%2C%20Millbury%2C%20OH%2043447!5e0!3m2!1sen!2sus!4v1573580891398!5m2!1sen!2sus"
                ...
                <div class="mail">
                  <div class="row">
                    <div class="col-sm-12">
                      <i aria-hidden="true" class="fa fa-map-marker footer-icon"></i>
                      <h4>4370 Moline Martin Rd <br />Millbury, OH 43447</h4>
                    </div>
                    <div class="col-sm-12">
                      <i aria-hidden="true" class="fa fa-phone footer-icon"></i>
                      <h4>559.794.7970</h4>
                    </div>
                    <div class="col-sm-12">
                      <i aria-hidden="true" class="fa fa-inbox footer-icon"></i>
                      <h4><a href="mailto:imm@sscorp.com">Email IMM</a></h4>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section class="mission">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9 tint">
              <div class="col-md-12">
                <p>Our guiding principle is to continually exceed the expectations of each of our customers. We build exceptional relationships and provide unprecedented customer service. To do this, we firmly believe that our work reaches outside
                  of the shop floor, by taking care of our employees and communities.</p>
              </div>
            </div>
          </div>
        </div>
